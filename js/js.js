...
window.onload = function(){
 ...
 //Pause
    ...
    //dificultats
         ...
         document.getElementsByClassName("m213")[0].onclick = function() {
         document.getElementsByClassName("m213")[0].style.display = "none";
      ...
      //facil
        document.getElementsByClassName("m212")[0].onclick = function() {
        document.getElementsByClassName("m212")[0].style.display = "none";
        document.getElementsByClassName("m213")[0].style.display = "block";
        stop();
		dt = 0.016683;
		y = 0; 
		v = 0;
...
function start(){
	...
	timer=setInterval(function(){ moverNave(); }, dt*moviment);
}
...
v.toFixed(2));
	...
	if (altitut.innerHTML>63){
		motorOff();
		document.onkeydown=null;
		
	}
	if  (altitut.innerHTML<60){
